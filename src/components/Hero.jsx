    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            C'est &nbsp;
            <span className="text-[#915eff]">AYOUB</span>
          </h1>
          <h2 className={`${styles.heroSubText}`}>BIENVENUE SUR MON PORTFOLIO</h2>
          <p
            className={`${styles.heroSubText}
          mt-2 text-white`}
          >
            <br className="sm:block hidden" /> 
            je code mon chemin vers &nbsp;
            <span className="text-[#915eff]">l'innovation</span>
          </p>
        </div>
      </div>
      <ComputersCanvas />
